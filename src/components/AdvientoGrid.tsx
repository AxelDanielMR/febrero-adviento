...
const advientoDays: AdvientoDay[] = [
  ...
  { day: 8, openDate: new Date('2026-02-08'), reward: { type: 'gif', content: '/images/emoxito.gif' } },
  { day: 9, openDate: new Date('2026-02-09'), reward: { type: 'image', content: '/images/cupon_chinos.png' } },
