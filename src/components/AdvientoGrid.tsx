...
const advientoDays: AdvientoDay[] = [
  ...
  { day: 8, openDate: new Date('2026-02-08'), reward: { type: 'gif', content: '/images/emoxito.gif?v=2' } },
  { day: 9, openDate: new Date('2026-02-09'), reward: { type: 'text', content: 'Un cupón especial\n\nPara escuchar\nun disco completo\njuntos :3\n\n🎵 🎶 🎵\n\nElige el álbum\nque más te guste\ny haremos una\nsesión de escucha\ncompleta ♡' } },
